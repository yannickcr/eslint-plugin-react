...
* [react/no-named-import](docs/rules/no-named-import.md): No named imports on React
* [react/no-namespace-import](docs/rules/no-namespace-import.md): No namespace import on React (fixable)
